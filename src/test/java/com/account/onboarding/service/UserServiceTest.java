...
public class UserServiceTest {
	...
	/**
	 * {@link UserServiceImpl#addUser(UserRequest)} This method tests when the user
	 * is saved to database when the hierarchy is returned from UserDaoImpl class
	 * 
	 */

	@Test
	public void addUserTest() {
		UserEntity user = new UserEntity("U2345", "Kiara", null, "abc", "Kiara", "Kevin", "kiara@abc.com", "9898988787",
				"java", new Date(), "U1234", "U1234", new Date(), 1, "", null, "U2345, U1234", null, null);
		UserRequest userRequest = new UserRequest("U2345", "Kiara", null, "abc", "", "Kiara", "Kevin", "kiara@abc.com",
	...
	/**
	 * {@link UserServiceImpl#addUser(UserRequest)#addUserTestElse()} This is the
	 * test method to check user is saved when the hierarchy is not returned from
	 * UserDaoImpl class
	 * 
	 */
	...
	public void addUserTestElse() {
		UserEntity user = new UserEntity("U2345", "Kiara", null, "abc", "Kiara", "Kevin", "kiara@abc.com", "9898988787",
				"java", new Date(), "U2345", "U2345", new Date(), 1, "", null, "", null, null);
		UserRequest userRequest = new UserRequest("U2345", "Kiara", null, "abc", "", "Kiara", "Kevin", "kiara@abc.com",
	...
	/**
	 * 
	 * {@link UserServiceImpl#updateUser(UserEdit)#updateTest()} This is the method
	 * to test whether the user is updated without exceptions
	 */
	@Test
	public void updateTest() {
		UserEntity user = new UserEntity("U2345", "Kiara", null, "abc", "Kiara", "Kevin", "kiara@abc.com", "9898988787",
				"java", new Date(), "U2345", "U2345", new Date(), 1, "", null, "U2345", null, null);
		...
		when(userRepository.save(user)).thenReturn(user);
		user.setRoleId(2);
		UserEntity userEdit1 = userService.updateUser(userEdit);
	...
	/**
	 * {@link UserServiceImpl#updateUser(UserEdit)#userNotUpdateRoleSame()} This is
	 * the method to check the test when the role entered is same of that particular
	 * user
	 * 
	 */
	@Test
	...
	/**
	 * {@link UserServiceImpl#updateUser(UserEdit)#userNotUpdateRoleInvalid()} This
	 * is the method that tests when the roleId entered is invalid
	 * 
	 */
	@Test
	 ...
	 * This is the method to check the test when the last updated by user does not
	 * exists
	 */
	@Test
	public void userNotUpdateCreatedByInvalid() {
		UserEntity user = new UserEntity("U2345", "Kiara", null, "abc", "Kiara", "Kevin", "kiara@abc.com", "9898988787",
				"java", new Date(), "U2346", "U2346", new Date(), 1, "", null, "U2345", null, null);
	 ...
	 * This method is to test when user details is not saved in database throws
	 * mongoexception
	 */
	@Test
	 ...
	 * This is the method to check when the update method does not work and throws
	 * exception
	 */
	@Test
	...
	public void testgetUser_failed() {
		try {
			when(userRepository.findByUserId("abc")).thenThrow(UserNotFoundException.class);
			userService.viewUser("abc");
		} catch (Exception e) {
	...
	public void testDeleteUser() {
		...
		Optional<UserEntity> optionalUser = Optional.of(getUser());
