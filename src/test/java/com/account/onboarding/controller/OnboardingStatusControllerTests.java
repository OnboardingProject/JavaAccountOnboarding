...
public class OnboardingStatusControllerTests {
	...
	public void givenProjectIdAndUserId_whenGetPreviewStatusReport_thenReturnStatusReportObject() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/onboarding-status/preview-report/P_1/U13")
	 ...
	 * 
	 * @Test public void
	 * givenProjectIdAndUserId_whenGetPreviewStatusReport_thenThrowProjectOnboardingException
	 * () throws Exception {
	 ...
	 * 
	 * mockMvc.perform(
	 * MockMvcRequestBuilders.get("/onboarding-status/preview-report/P_1/U13").
	 ...
	 * verify(onboardingStatusService, times(1)).getPreviewStatusReport(any(),
	 * any()); }
	 */
	 ...
	 * 
	 * @Test public void
	 * givenProjectIdAndUserId_whenGetPreviewStatusReport_thenThrowException()
	 * throws Exception { when(onboardingStatusService.getPreviewStatusReport(any(),
	 * any())) .thenThrow(new
	...
	public void givenProjectIdAndUserId_whenExportStatusReportInExcelFormat_thenReturnStatusReportObject() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/onboarding-status/export-report/P_1/U13")
				.contentType(MediaType.APPLICATION_JSON).content(asJsonString(statusReport))).andExpect(status().isOk())
				.andDo(MockMvcResultHandlers.print())
	 ...
	 * 
	 * @Test public void
	 * givenProjectIdAndUserId_whenExportStatusReportInExcelFormat_thenThrowProjectOnboardingException
	 * () throws Exception {
	 ...
	 * 
	 * mockMvc.perform(
	 * MockMvcRequestBuilders.get("/onboarding-status/export-report/P_1/U13").
	 * contentType(MediaType.APPLICATION_JSON))
	 * .andExpect(status().isNotFound()).andDo(MockMvcResultHandlers.print())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * verify(onboardingStatusService,
	 * times(1)).exportStatusReportInExcelFormat(any(), any()); }
	 */
	 ...
	 * 
	 * @Test public void
	 * givenProjectIdAndUserId_whenExportStatusReportInExcelFormat_thenThrowException
	 * () throws Exception {
	 * when(onboardingStatusService.exportStatusReportInExcelFormat(any(), any()))
