...
public class ProjectTasksControllerTests {
	...
	public void init() {
		...
		task1 = new Task(1, "Seat Allocation", "User Need Seat Allocation", "Software Engineer",2,null,"");
		taskList.add(task1);
		task2 = new Task(2, "Chair allocation", "User Need Chair Allocation", "System Analyst",2,null,"");
		taskList.add(task2);
		task3 = new Task(3, "Laptop allocation", "User Need Laptop Allocation", "Software Engineer",2,null,"");
		taskList.add(task3);
	...
	public void getAllTaskByProjectSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/project-tasks/fetch-project-tasks/P_001")
	 ...
	 * 
	 * @Test public void getProjectTasksByProjectIdFailuerTest() throws Exception {
	 * projectList.clear(); taskList.clear();
	 * 
	 * when(projectTasksService.getProjectTasksByProjectId("P_001")) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-tasks/fetch-project-tasks/P_001")
	 ...
	 * )); verify(projectTasksService,
	 * times(1)).getProjectTasksByProjectId("P_001");
	 * 
	 * }
	 */
	...
	public void addOrEditTaskSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/project-tasks/add-or-edit-task")
	 ...
	 * 
	 * @Test public void addOrEditTaskFailureTest() throws Exception {
	 * task1.setTaskId(0);
	 * 
	 * when(projectTasksService.addOrEditTask(any())) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.post(
	 * "/project-tasks/add-or-edit-task")
	 * .contentType(MediaType.APPLICATION_JSON).content(asJsonString(
	 * projectTaskRequest)))
	 * .andExpect(MockMvcResultMatchers.status().isNotFound()).andDo(
	 ...
	 * )
	 * 
	 * @Test public void getProjectTasksByProjectIdInternalServerFailuerTest()
	 * throws Exception { Task tasks = new Task();
	 * when(projectTasksService.getProjectTasksByProjectId("P_001")) .thenThrow(new
	 ...
	 * print()) .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage")
	 ...
	 * 
	 * @Test public void addOrEditTasksInternalServerFailuerTest() throws Exception
	 * { when(projectTasksService.addOrEditTask(any())) .thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.post(
	...
	public void deleteTasksSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.put("/project-tasks/delete-task")
	 ...
	 * 
	 * @Test public void deleteTasksFailureTest() throws Exception {
	 * when(projectTasksService.deleteTask(any())) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.put("/project-tasks/delete-task")
	 * .contentType(MediaType.APPLICATION_JSON).content(asJsonString(
	 * deleteTaskRequest))) .andExpect(MockMvcResultMatchers.status().isConflict())
	 * .andDo(MockMvcResultHandlers.print())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage")
	 * .value(ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * 
	 ...
	 * 
	 * @Test public void deleteTasksInternalServerFailuerTest() throws Exception {
	 * when(projectTasksService.deleteTask(any())) .thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.put("/project-tasks/delete-task")
