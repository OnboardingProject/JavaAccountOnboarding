...
public class ProjectOnboardingControllerTests {
	...
	public void getProjectsBasedOnUserSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/project-onboarding/projects/U11").contentType(MediaType.APPLICATION_JSON))
	 ...
	 * 
	 * @Test public void getProjectsBasedOnUserFailureTest() throws Exception {
	 * 
	 * when(projectOnboardingService.getProjectsBasedOnUser(any())) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.USER_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get("/project-onboarding/projects/U11"
	 * ).contentType(MediaType.APPLICATION_JSON))
	 * .andExpect(MockMvcResultMatchers.status().isConflict())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.USER_NOT_FOUND)); }
	 */
	...
	public void getResourcesBasedOnProjectSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/project-onboarding/resources/P_001").contentType(MediaType.APPLICATION_JSON))
				.andExpect(MockMvcResultMatchers.status().isFound());
	}
	 ...
	 * )
	 * 
	 * @Test public void getResourcesBasedOnProjectFailureTest() throws Exception {
	 * 
	 * when(projectOnboardingService.getUsersBasedOnProject(any())) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-onboarding/resources/P_001").contentType(MediaType.APPLICATION_JSON
	 * )) .andExpect(MockMvcResultMatchers.status().isConflict())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.PROJECT_NOT_FOUND));
	 * 
	 * }
	 */
	 ...
	 * 
	 * @Test public void getProjectsBasedOnUserFailureThrowExceptionTest() throws
	 * Exception {
	 * when(projectOnboardingService.getProjectsBasedOnUser(any())).thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-onboarding/projects/U11") .contentType(MediaType.APPLICATION_JSON))
	 * .andExpect(MockMvcResultMatchers.status().isInternalServerError())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * }
	 */
	 ...
	 * )
	 * 
	 * @Test public void getResourcesBasedOnProjectFailureThrowExceptionTest()
	 * throws Exception {
	 * when(projectOnboardingService.getUsersBasedOnProject(any())).thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-onboarding/resources/P_001")
	 * .contentType(MediaType.APPLICATION_JSON))
	 * .andExpect(MockMvcResultMatchers.status().isInternalServerError())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.INTERNAL_SERVER_ERROR)); }
	...
	public void getAllTasklistSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/project-onboarding/view-tasks/P_001/U11").contentType(MediaType.APPLICATION_JSON))
	 ...
	 * 
	 * @Test public void getAllTasklistFailureTest() throws Exception {
	 * when(projectOnboardingService.fetchTaskList("P_001", "U11")) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.TASK_LIST_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-onboarding/view-tasks/P_001/U11")
	 * .contentType(MediaType.APPLICATION_JSON).content(asJsonString(taskList)))
	 * .andExpect(MockMvcResultMatchers.status().isConflict()).andDo(
	...
	public void saveTaskStatusSuccessTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.put("/project-onboarding/save-task-status").contentType(MediaType.APPLICATION_JSON)
	 ...
	 * 
	 * @Test public void saveTaskStatusFailureTest() throws Exception {
	 * when(projectOnboardingService.saveStatus(any())) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.TASK_LIST_NOT_FOUND));
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.put(
	 * "/project-onboarding/save-task-status").contentType(MediaType.
	 * APPLICATION_JSON) .content(asJsonString(saveTaskStatusRequest))).andExpect(
	 * MockMvcResultMatchers.status().isConflict())
	 * .andDo(MockMvcResultHandlers.print())
	 * .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.TASK_LIST_NOT_FOUND));
	...
	public void testFetchAllTaskStatusSucess() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/project-onboarding/fetch-task-status")
	 ...
	 * 
	 * @Test public void testFetchAllTaskStatusFailure_ThenThrowException() throws
	 * Exception {
	 * 
	 * when(projectOnboardingService.getAllTaskStatus()) .thenThrow(new
	 * ProjectOnboardingException(ProjectOnboardingConstant.STATUS_LIST_EMPTY));
	 * mockMvc.perform(MockMvcRequestBuilders.get(
	 * "/project-onboarding/fetch-task-status")
	 * .contentType(MediaType.APPLICATION_JSON).content(asJsonString(types))).
	 * andExpect(MockMvcResultMatchers.status().isConflict())
	 * .andDo(MockMvcResultHandlers.print()).andExpect(
	 * MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.STATUS_LIST_EMPTY));
	 ...
	 * 
	 * @Test public void
	 * givenSaveStatusRequest_whenSaveTaskStatus_thenThrowException() throws
	 * Exception { when(projectOnboardingService.saveStatus(any())).thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(
	 * MockMvcRequestBuilders.put("/project-onboarding/save-task-status").
	 * contentType(MediaType.APPLICATION_JSON)
	 * .content(asJsonString(saveTaskStatusRequest)))
	 * .andExpect(status().isInternalServerError()).andDo(MockMvcResultHandlers.
	 * print()) .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * verify(projectOnboardingService, times(1)).saveStatus(any()); }
	 */
	 ...
	 * 
	 * @Test public void
	 * givenProjectIdAndUserId_whenGetAllTasks_thenThrowException() throws Exception
	 * { when(projectOnboardingService.fetchTaskList(any(), any())).thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 * 
	 * mockMvc.perform(
	 * MockMvcRequestBuilders.get("/project-onboarding/view-tasks/P_001/U11").
	 * contentType(MediaType.APPLICATION_JSON))
	 * .andExpect(status().isInternalServerError()).andDo(MockMvcResultHandlers.
	 * print()) .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value(
	 * ProjectOnboardingConstant.INTERNAL_SERVER_ERROR));
	 ...
	 * 
	 * @Test public void
	 * testtestFetchAllTaskStatusInternalServerFailure_ThenThrowException() throws
	 * Exception { when(projectOnboardingService.getAllTaskStatus()).thenThrow(new
	 * Exception(ProjectOnboardingConstant.INTERNAL_SERVER_ERROR)); mockMvc.perform(
	 * MockMvcRequestBuilders.get("/project-onboarding/fetch-task-status").
	 * contentType(MediaType.APPLICATION_JSON) .content(asJsonString(types)))
